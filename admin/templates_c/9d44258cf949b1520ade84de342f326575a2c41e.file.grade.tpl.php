<?php /* Smarty version Smarty-3.0.8, created on 2017-03-17 17:20:35
         compiled from "./templates/grade/grade.tpl" */ ?>
<?php /*%%SmartyHeaderCode:206628879458cbcd8b0db192-27733066%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d44258cf949b1520ade84de342f326575a2c41e' => 
    array (
      0 => './templates/grade/grade.tpl',
      1 => 1478065596,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '206628879458cbcd8b0db192-27733066',
  'function' => 
  array (
  ),
...
"><?php echo $_smarty_tpl->getVariable('category_names')->value[$_smarty_tpl->getVariable('smarty')->value['section']['category']['index']];?>
					...
					<div class="col-lg-4">	
						<div class="form-group">
							<input class="form-control" name="grade" value="<?php echo $_smarty_tpl->getVariable('grade')->value;?>
" required placeholder="grade">
						</div>
					</div>
...
list_grade();<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_php(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
